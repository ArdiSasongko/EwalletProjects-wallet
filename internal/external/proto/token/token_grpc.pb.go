...
func (c *tokenServiceClient) Validate(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
...
func (UnimplementedTokenServiceServer) Validate(context.Context, *TokenRequest) (*TokenResponse, error) {
...
func _TokenService_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServiceServer).Validate(ctx, req.(*TokenRequest))
	}
